...
def add_item():
    try:
        ...
        new_item = Shop(name=name,category_name=category_name,description=description,buy_price=buy_price,sell_price=sell_price, quantity=quantity)
